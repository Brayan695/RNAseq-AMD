...
distance = read.csv("C:/Users/Brayan Gutierrez/Desktop/RNAseq-AMD/Dataset/bhattacharyya_edges_late.csv")
...
visNetwork(nodes_unique, edges, main = "MEGENA Bhattacharyya Distance 100 (MGS4)") %>%
