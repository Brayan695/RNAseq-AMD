...
distance = read.csv("C:/Users/Brayan Gutierrez/Desktop/RNAseq-AMD/Dataset/bhattacharyya_edges.csv")
...
visNetwork(nodes_unique, edges, main = "MEGENA Bhattacharyya Distance 100 (MGS1 + MGS4)") %>%
