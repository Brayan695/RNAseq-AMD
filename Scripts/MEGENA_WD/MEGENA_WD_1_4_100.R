...
distance = read.csv("C:/Users/Brayan Gutierrez/Desktop/RNAseq-AMD/Dataset/wasserstein_edges.csv")

# Converts Distances -> Similarities
...
visNetwork(nodes_unique, edges, main = "MEGENA Wasserstein Distance 100 (MGS1 + MGS4)") %>%
